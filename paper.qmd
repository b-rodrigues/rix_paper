...
focus on R packages and do not address system-level dependencies or R version
...
in the Guix-provided environment but does not benefit from the additional
...
declarative framework using `rix` and `rixpress`. While both approaches
