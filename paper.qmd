...
software in a completely reproducible manner. With [Nix]{.proglang}
it is possible to install [R]{.proglang} and [R]{.proglang} packages as well
(whether these come from CRAN or Bioconductor)
