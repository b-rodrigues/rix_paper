...
[Nix]{.pkg} can serve the roles commonly assigned to [Docker]{.pkg} for
isolation, [renv]{.pkg} for package management, and [Make]{.pkg} for
orchestration—all within a single, unified framework. However, it has a steep
