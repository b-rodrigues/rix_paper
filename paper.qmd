...
[@dockerfiler] are specifically made to enable this type of post-hoc reproducibility.
...
([boost]{.pkg}), a pull request was submitted to the official `nixpkgs` repository. I
...
language-agnostic [Arrow]{.pkg} format using the pair of `encoder/decoder` functions.
