...
studies, which is not reproducible at all. Then, if to this paper we make the
original source code of the analysis that was written to compute the results of
the study available, reproducibility is improved, albeit only by a little.
Adding the original data to this package improves reproducibility yet again. Finally,
if to all this we add what Roger Peng named the *linked and executable code and data*,
we reach the gold standard of full replication.
...
- First, the version of [R]{.proglang} was stated
