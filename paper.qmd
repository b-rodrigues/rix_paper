...
same inputs, regardless of where or when a package gets built. [Nix]{.pkg} 
also allows for multiple versions (or variants in the [Nix]{.pkg} jargon)
...
[Nix]{.pkg} expressions are written in the [Nix]{.proglang} programming language,
