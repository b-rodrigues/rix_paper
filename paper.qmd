...
This call to `rix()` generates a `default.nix` that builds a development shell
which ships [R]{.proglang} and [R]{.proglang} packages (including [AER]{.pkg} version 1.2-8), several TeXLive
