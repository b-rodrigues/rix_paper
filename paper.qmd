...
binaries across any Linux system where [Nix]{.pkg} is installed. This “build
once, run anywhere” property has long been solved by [Nix]{.pkg}, and is now
being revisited by Posit through its initiative to provide portable CRAN
binaries [@posit_portable_r_binaries].
