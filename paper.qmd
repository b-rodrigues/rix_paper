...
By combining the strengths of Nix and container technologies, it is possible to
enhance both build-time and runtime isolation. For example, installing [Nix].pkg
directly into container images reduces the setup overhead by avoiding the need
to install derivations into the host operating system's `/nix` directory.
...
hermetic build process of a derivation. [BioNix]{.pkg} [@bionix2020] takes this
