...
abstract: |
  ...
  Existing tools like [Docker]{.pkg} and [renv]{.pkg} address parts of this challenge, but no single solution handles polyglot environments, 
  system dependencies, and pipeline orchestration together. I present two [R]{.proglang} packages that leverage [Nix]{.pkg} to provide both reproducible polyglot 
...
For a more in-depth technical discussion of [Nix]{.pkg}'s design principles, I refer readers to @dolstra2004nix.
...
report. The code to this example can be found in the  
...
orchestration of polyglot analyses, making it easier to manage complex
