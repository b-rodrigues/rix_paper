...
hermetic build process of a derivation. As we will show, [rixpress]{.pkg} takes
a different approach: each pipeline step is itself a [Nix]{.pkg} derivation,
meaning the entire analysis—not just the environment—is subject to the same
