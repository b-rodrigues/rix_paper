...
[renv]{.pkg} 
documentation^[\url{https://rstudio.github.io/renv/articles/renv.html#caveats}].
...
\begin{CodeInput}
$> nix-shell -I \
+  nixpkgs=https://github.com/rstats-on-nix/nixpkgs/archive/2025-10-20.tar.gz -p \
+  R rPackages.rix
\end{CodeInput}
```
...
It is possible to run this complete example by executing the shell
script called `run_polyglot_example.sh` found in the repository of
this 
paper^[\url{https://github.com/b-rodrigues/rix_paper/blob/master/run_polyglot_example.sh}].
