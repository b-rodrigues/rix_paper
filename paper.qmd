...
3.  It then defines the series of **Python steps** (feature preparation, training, prediction), 
  ...
  made dependent on the output from the Julia simulation. [rixpress]{.pkg} handles the passing of data 
...
To execute this entire example, a user with Nix installed can simply run the 
`run_polyglot_example.sh` script available in the root of the paper's repository.
